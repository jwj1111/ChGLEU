# ChGLEU: Tool for Chinese Grammatical Error Correction Metric
This repository contains a Python implementation of the **ChGLEU**, a specialized evaluation tool for **Chinese Grammatical Error Correction (CGEC)** tasks.

ChGLEU is adapted from the GLEU proposed by Napoles et al. (2015, 2016). While the original GLEU was designed for English, **ChGLEU** is optimized for Chinese by employing **character-level n-gram** calculation to better handle Chinese issues.
